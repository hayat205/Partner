...
class Deja extends StatefulWidget with NavigationStates {
  @override
...
class DejaState extends State<Deja> {
  bool _visible = false;
  @override
                ...
                Positioned(
                  child: FadeAnimation(
                    ...
                    Container(
                      ...
                      child: Text(
                        'Se connecter à mon compte PARTNER\n\n',
                        style: TextStyle(color: Colors.lightBlue, fontSize: 22, fontWeight: FontWeight.w900, fontFamily: "VitalaRegular",),
